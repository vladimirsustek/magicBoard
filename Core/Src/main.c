...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : NRF2_PWR_Pin NRF1_CS_Pin */
  GPIO_InitStruct.Pin = NRF2_PWR_Pin|NRF1_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : NRF2_CE_Pin NRF1_CE_Pin */
  GPIO_InitStruct.Pin = NRF2_CE_Pin|NRF1_CE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : NRF1_IRQ_Pin */
